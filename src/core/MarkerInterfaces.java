...
public interface MarkerInterfaces extends Serializable, Cloneable{
	...
	//If Serializable interface is mentioned, JVM will convert the states of an object to stream of bytes that used to written on disk or transfer over nextwork
